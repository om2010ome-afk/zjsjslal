      ...
      <footer className="border-t border-[rgba(255,255,255,0.06)] py-8">
        <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <button onClick={() => navigate('/terms')} className="text-sm text-[#666] hover:text-[#C9A86A] transition-colors">
              شروط الاستخدام
            </button>
            <button onClick={() => navigate('/privacy')} className="text-sm text-[#666] hover:text-[#C9A86A] transition-colors">
              سياسة الخصوصية
            </button>
          </div>
        </div>
