...
export const DashboardPage: React.FC = () => {
  ...
  const { user, fonts, jobs, setCurrentFont, setCurrentJob, removeFont } = useStore();
        ...
        <div className="mb-8">
          ...
          {fonts.length === 0 ? (
            <EmptyState
              ...
              action={
                <LuxuryButton variant="secondary" onClick={() => navigate('/upload')} icon={<Upload className="w-4 h-4" />}>
                  رفع خط
                </LuxuryButton>
              }
            />
