...
export const AccountPage: React.FC = () => {
  ...
  const { user, fonts, jobs, logout } = useStore();
    ...
    return (
      <div className="min-h-screen bg-[#050505] flex items-center justify-center">
        <div className="text-center">
          ...
          <LuxuryButton variant="gold" onClick={() => navigate('/login')}>تسجيل الدخول</LuxuryButton>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#050505] pb-24 md:pb-8">
      <TopHeader title="حسابي" showBack backPath="/dashboard" />
      ...
      <div className="max-w-2xl mx-auto px-4 pt-6">
        ...
        {/* Actions */}
        <div className="space-y-3">
          <GlassCard delay={0.3} hoverable padding="sm" onClick={() => navigate('/terms')}>
          ...
          <GlassCard delay={0.35} hoverable padding="sm" onClick={() => navigate('/privacy')}>
            <div className="flex items-center gap-3">
              <Shield className="w-5 h-5 text-[#8A8A8A]" />
